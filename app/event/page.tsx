  ...
  return (
    <div className="md:max-w-3xl mx-auto px-6 py-12 text-gray-700">
      <h1 className="text-3xl font-bold text-center text-teal-700">
        🎉 MARCH MADNESS WEBSITE GIVEAWAY! 🎉
      </h1>
      <p className="text-lg text-center mt-4">
        Do you know a nonprofit, startup, or small business in WNC that&#39;s
        ...
        , I want to give back by building free websites for those who need them
        most.
      </p>
      ...
      <div className="bg-white-100 p-6 rounded-2xl shadow-lg mt-6">
        ...
        <ul className="list-disc pl-6 mt-2">
          ...
          <li>
            Why they deserve a free website (the more compelling, the better!)
          </li>
          <li>
      ...
      <div className="bg-gray-100 p-6 mb-8 rounded-2xl shadow-lg mt-6">
        ...
        <p className="list-none pl-0 mt-2">
          🏆 <span className="font-bold">Two lucky winners</span> will receive a
        ...
        <br />
        <p>
          🎉 <span className="font-bold">Bonus:</span> Up to three more will
          receive an exclusive <span className="font-bold">50% discount</span>{" "}
          on a website:
        </p>
        <ul className="list-disc pl-6">
          <li>Landing page: $150 (normally $300)</li>
          <li>
            Professional website of up to five pages: $250 (normally $500)
          </li>
        </ul>
      </div>
      <p className="text-center">
        I will handpick the most compelling entries based on their story, need,
